...
func GenerateNoiseMap(width int, height int, octaves int, stretch float64, multiplier float64) []float64 {
...
func MergeNoiseData(multipliers []float64, layers ...[]float64) []float64 {
